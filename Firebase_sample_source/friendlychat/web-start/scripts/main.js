...
FriendlyChat.prototype.initFirebase = function() {
  ...
  // Shortcuts to Firebase SDK features.追記箇所
...
FriendlyChat.prototype.loadMessages = function() {
  ...
  // Reference to the /messages/ database path.追記箇所
...
FriendlyChat.prototype.saveMessage = function(e) {
  ...
  if (this.messageInput.value && this.checkSignedInWithMessage()) {
    ...
    // TODO(DEVELOPER): push new message to Firebase.  追記箇所
...
FriendlyChat.prototype.setImageUrl = function(imageUri, imgElement) {
  ...
  // Sets the URL of the given img element with the URL of the image stored in Firebase Storage. 追記箇所
...
FriendlyChat.prototype.saveImageMessage = function(event) {
  ...
  if (this.checkSignedInWithMessage()) {
    ...
    // We add a message with a loading icon that will get updated with the shared image. 追記箇所
    var currentUser = this.auth.currentUser;
    this.messagesRef.push({
      name: currentUser.displayName,
...
FriendlyChat.prototype.checkSignedInWithMessage = function() {
  ...
  // Return true if the user is signed in Firebase追記箇所
